...
getUrlParameter()
		...
		// switch( parm ) {
		// 	case 'thGirl':
		// 		container.load('cases/peasantGirl.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thElephant':
		// 		container.load('cases/indianChess.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thStreet':
		// 		container.load('cases/germanStreet.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thLandscape':
		// 		container.load('cases/dutchLandscape.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thBird':
		// 		container.load('cases/femaleBird.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thPitt':
		// 		container.load('cases/mrsPitt.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thVirgin':
		// 		container.load('cases/virginMary.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thLilacs':
		// 		container.load('cases/lilacs.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thWoman':
		// 		container.load('cases/portraitWoman.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thSaints':
		// 		container.load('cases/saintsSamon.html').hide('600').fadeIn('4800');
		// 		break;
		// 		case 'thMan':
		// 		container.load('cases/earlyAmericanPortrait.html').hide('600').fadeIn('4800');
		// 		break;
		// }
